...
| **Infrastructure** | `Docker` `GCP` `GitHub Actions` `REST APIs` |
...
* **Tech:** Flask, Groq, Sentence Transformers, Endee

### [EcoLifestyle Agent](https://github.com/yourusername/ecolifestyle)
*Document-grounded sustainability advisor.*
* **Implementation:** Built on **IBM Watsonx.ai** using RAG over curated sustainability corpora for green product guidance.
* **Tech:** IBM Watsonx.ai, Python

### [GHG Emission Predictor](https://github.com/yourusername/ghg-predictor)
*ML model for predicting industrial greenhouse gas emission patterns from historical data.*
...
<p align="left">
<img src="https://github-readme-stats.vercel.app/api?username=saumyaraj&show_icons=true&theme=radical" alt="Saumya's Stats" height="150" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=saumyaraj&layout=compact&theme=radical" alt="Top Languages" height="150" />
</p>
...
* **AI Intern @ Edunet Foundation:** Focused on ML on real telecom datasets at scale.
* **Cybersecurity & AI @ IBM SkillsBuild:** Security fundamentals and cloud workflows.
* **AI/ML Virtual Intern @ Shell × AICTE.**
* **Data Analytics Simulation @ Deloitte (Forage).**
* **Cisco Cybersecurity Certified.**
* **Published Author** on [AWS Builder Center](https://aws.amazon.com/blogs/builders/).
